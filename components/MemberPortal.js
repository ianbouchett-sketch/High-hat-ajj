      ...
      {view==='feed'&&<div>
        ...
        <div style={{background:CARD,border:`1px solid ${BL}`,borderRadius:10,padding:'16px 18px',marginBottom:14}}>
          ...
          {postImagePreview&&<div style={{marginBottom:10,position:'relative',display:'inline-block'}}>
            <img src={postImagePreview} alt="preview" style={{maxWidth:'100%',maxHeight:200,borderRadius:6,objectFit:'cover',border:`1px solid ${BL}`,display:'block'}}/>
            <button onClick={()=>{setPostImage(null);setPostImagePreview(null);}} style={{position:'absolute',top:-6,right:-6,width:22,height:22,borderRadius:'50%',background:'#3a0a0a',border:'1px solid #7a2020',color:'#ff6666',fontSize:14,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',lineHeight:1}}>×</button>
          </div>}
