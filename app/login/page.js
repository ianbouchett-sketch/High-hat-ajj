      ...
      <div style={{width:'100%',maxWidth:400}}>
        ...
        <div style={{background:CARD,border:`1px solid ${BL}`,borderRadius:6,overflow:'hidden'}}>
          ...
          <div style={{padding:28}}>
            <div style={{fontWeight:800,fontSize:20,letterSpacing:2,color:'#fff',textTransform:'uppercase',marginBottom:6,fontFamily:F}}>Member Sign In</div>
            <div style={{color:'#444',fontSize:13,marginBottom:24,fontFamily:FB}}>Access your member portal</div>
            <div style={{display:'flex',flexDirection:'column',gap:16}}>
              ...
              <div>
                <div style={{color:GD,fontSize:10,letterSpacing:1.5,textTransform:'uppercase',marginBottom:6,fontWeight:800,fontFamily:F}}>Email</div>
              ...
              <div>
                <div style={{color:GD,fontSize:10,letterSpacing:1.5,textTransform:'uppercase',marginBottom:6,fontWeight:800,fontFamily:F}}>Password</div>
